...
def double_correlation_autoscale(y_true, model_out, split_idx, A1, alpha1, num_propagations1, A2, alpha2, num_propagations2, num_hops=1, device='cuda', display=True):
    ...
    y = pre_residual_correlation(labels=y_true, model_out=model_out, label_idx=residual_idx)
    ...
    y = pre_outcome_correlation(labels=y_true, model_out=res_result, label_idx = label_idx)
